...
main.js — WorkflowIntegration.node → live Resolve object
        — tools.js: 22 JS tools + run_javascript (grab_still vision, compare_stills, pipeline_doctor, qc_scan, match_shot)
...
|---|---|---|
| Tools | 70, incl. grading/Fusion/Higgsfield | 23 incl. `grab_still` vision, colour suite (`pipeline_doctor`, `qc_scan`, `match_shot`, `compare_stills`) + `run_javascript` |
