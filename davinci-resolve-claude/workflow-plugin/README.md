...
main.js — WorkflowIntegration.node → live Resolve object
        — tools.js: 27 JS tools + run_javascript (grab_still vision, colour suite: pipeline_doctor, qc_scan, match_shot, design_look, apply_vignette)
...
|---|---|---|
| Tools | 70, incl. grading/Fusion/Higgsfield | 28 incl. `grab_still` vision, colour suite (`pipeline_doctor`, `qc_scan`, `match_shot`, `design_look`, `apply_vignette`) + `run_javascript` |
