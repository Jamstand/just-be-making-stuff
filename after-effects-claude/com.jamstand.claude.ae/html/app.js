...
// Commands the page answers itself, never sent to the model.
function localCommand(text) {
  ...
  if (c.name === "help") return () => card("notice", "NOTE",
    ...
    + "\n\nOr just ask in plain words — what's in the project, make a comp, track that logo, put the beat on the timeline.");
  return null;
}
